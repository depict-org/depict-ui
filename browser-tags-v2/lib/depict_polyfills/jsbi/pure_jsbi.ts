...
//
//
// Changes: instead of just exporting the class, export a function returning the class to make it side-effects free


export default () => class JSBI extends Array {
