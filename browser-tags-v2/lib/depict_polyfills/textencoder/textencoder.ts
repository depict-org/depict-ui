import { encoding_indexes } from "./encoding_indexes";
...
export function polyfill_textencoder_textdecoder() {
  if (process.env.BUILD_TARGET === "ie11" && !has_ran) {
    has_ran = true;
    //
    // Utilities
    //
     ...
     */
    function GB18030Encoder(options, gbk_flag?: boolean) {
      var fatal = options.fatal;
