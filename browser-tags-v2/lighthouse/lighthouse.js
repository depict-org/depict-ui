...
var tenants = require("./tenants.json");
var test = function () { return __awaiter(void 0, void 0, void 0, function () {
    var chrome, _i, tenants_1, tenant, runnerResult1, r2, diff;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                tenant = tenants_1[_i];
                return [4 /*yield*/, lighthouse(tenant.site, {
                        // logLevel: "info",
                        output: "html",
            ...
            case 4:
                r2 = _a.sent();
                diff = runnerResult1.lhr.categories.performance.score - r2.lhr.categories.performance.score;
                console.log("Diff on", tenant.name, "is", Math.round(diff * 1e2), "(lower is better)");
                _a.label = 5;
            case 5:
                _i++;
                return [3 /*break*/, 2];
            case 6: return [4 /*yield*/, chrome.kill()];
            case 7:
                _a.sent();
                return [2 /*return*/];
        }
