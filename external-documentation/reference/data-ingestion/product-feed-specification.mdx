...
<ResponseField name="Item group ID" type="string">
...
<ResponseField name="Sale price" type="float">
...
<ResponseField name="Main Image URL" type="string">
The URL of the product's main image.Example value: `https://yourstore.com/img1.jpg`.
</ResponseField>

<ResponseField name="Additional image URL" type="[string]">
...
<ResponseField name="Page URL" type="string">
...
<ResponseField name="Category ids" type="[string]">
...
<ResponseField name="Designer" type="string">
