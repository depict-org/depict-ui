...
<CardGroup cols={3}>
  <Card title="React UI" icon="react" iconType="duotone" href="/react-ui-guide/introduction">
  </Card>

  <Card title="JavaScript UI" icon="square-js" iconType="duotone" href="/js-ui-guide/introduction">
  </Card>

  <Card title="API" icon="server" iconType="duotone" href="/api-guide/introduction">
  </Card>

  <Card title="Shopify" icon="shopify" iconType="duotone" href="/shopify-guide/introduction">
  </Card>
</CardGroup>
